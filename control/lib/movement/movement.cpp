...
void key_input_callback(const void *msgin)
{
  ...
  int8_t key = msg->data;
  Serial.printf("keyboard number %d", key);
   switch(key) {
    case 1: // Forward
      l298n[0].set_speed(default_speed);
      l298n[1].set_speed(default_speed);
      l298n[0].set_direction(1);
      l298n[1].set_direction(1);
      break;
    case 2: // Backward
      l298n[0].set_speed(default_speed);
      l298n[1].set_speed(default_speed);
    ...
    default: // Stop
      l298n[0].set_speed(0);
      l298n[1].set_speed(0);
      l298n[0].set_direction(0);
      l298n[1].set_direction(0);
}
}
