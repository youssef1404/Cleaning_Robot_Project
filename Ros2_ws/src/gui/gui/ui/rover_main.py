...
################################################################################
## Form generated from reading UI file 'rover_main.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        brush8 = QBrush(QColor(239, 141, 145, 255))
...
#endif
        brush10 = QBrush(QColor(128, 128, 128, 255))
        ...
        brush11 = QBrush(QColor(224, 27, 36, 255))
...
"}")
        ...
        self.groupBox.setGeometry(QRect(1050, 130, 301, 311))
        self.label_6 = QLabel(self.groupBox)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(10, 30, 131, 31))
        font1 = QFont()
        font1.setPointSize(14)
        self.label_6.setFont(font1)
        self.speed_label_1 = QLabel(self.groupBox)
        self.speed_label_1.setObjectName(u"speed_label_1")
        self.speed_label_1.setGeometry(QRect(160, 30, 111, 31))
        font2 = QFont()
        font2.setPointSize(13)
        self.speed_label_1.setFont(font2)
        self.label_7 = QLabel(self.groupBox)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(10, 80, 131, 31))
        self.label_7.setFont(font1)
        self.speed_label_2 = QLabel(self.groupBox)
        self.speed_label_2.setObjectName(u"speed_label_2")
        self.speed_label_2.setGeometry(QRect(160, 80, 131, 31))
        self.speed_label_2.setFont(font2)
        self.label_11 = QLabel(self.groupBox)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(10, 130, 161, 31))
        self.label_11.setFont(font1)
        self.label_12 = QLabel(self.groupBox)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(10, 180, 161, 31))
        self.label_12.setFont(font1)
        self.count_label_1 = QLabel(self.groupBox)
        self.count_label_1.setObjectName(u"count_label_1")
        self.count_label_1.setGeometry(QRect(170, 130, 121, 31))
        self.count_label_1.setFont(font2)
        self.count_label_2 = QLabel(self.groupBox)
        self.count_label_2.setObjectName(u"count_label_2")
        self.count_label_2.setGeometry(QRect(170, 180, 121, 31))
        self.count_label_2.setFont(font2)
        self.label_14 = QLabel(self.groupBox)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(10, 220, 71, 31))
        self.label_14.setFont(font1)
        self.label_15 = QLabel(self.groupBox)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(10, 260, 91, 31))
        self.label_15.setFont(font1)
        self.speed_label = QLabel(self.groupBox)
        self.speed_label.setObjectName(u"speed_label")
        self.speed_label.setGeometry(QRect(80, 220, 121, 31))
        self.speed_label.setFont(font2)
        self.dir_label = QLabel(self.groupBox)
        self.dir_label.setObjectName(u"dir_label")
        self.dir_label.setGeometry(QRect(100, 260, 121, 31))
        self.dir_label.setFont(font2)
        self.camera_label = QLabel(Form)
        self.camera_label.setObjectName(u"camera_label")
        self.camera_label.setGeometry(QRect(60, 120, 960, 540))
        self.label_9 = QLabel(Form)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(550, 10, 331, 41))
        palette1 = QPalette()
        ...
        self.manuel_button = QPushButton(Form)
        self.manuel_button.setObjectName(u"manuel_button")
        self.manuel_button.setGeometry(QRect(1200, 560, 121, 41))
        font4 = QFont()
        font4.setFamilies([u"Ubuntu"])
        font4.setBold(False)
        font4.setItalic(False)
        self.manuel_button.setFont(font4)
        self.manuel_button.setMouseTracking(True)
        self.auto_button = QPushButton(Form)
        self.auto_button.setObjectName(u"auto_button")
        self.auto_button.setGeometry(QRect(1060, 560, 111, 41))
        self.auto_button.setFont(font4)
        self.auto_button.setMouseTracking(True)
        self.frame_2 = QFrame(Form)
        self.frame_2.setObjectName(u"frame_2")
        self.frame_2.setGeometry(QRect(1060, 50, 241, 61))
        self.frame_2.setFrameShape(QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QFrame.Raised)
        self.timeLabel = QLabel(self.frame_2)
        self.timeLabel.setObjectName(u"timeLabel")
        self.timeLabel.setGeometry(QRect(70, 10, 171, 41))
        self.timeLabel.setFont(font1)
        self.label_3 = QLabel(self.frame_2)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(10, 10, 51, 31))
        self.label_3.setFont(font1)
        self.label = QLabel(Form)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(510, 80, 101, 21))
        self.screenButton = QPushButton(Form)
        self.screenButton.setObjectName(u"screenButton")
        self.screenButton.setGeometry(QRect(380, 690, 261, 41))
        font5 = QFont()
        self.screenButton.setFont(font5)
        self.frame_6 = QFrame(Form)
        self.frame_6.setObjectName(u"frame_6")
        self.frame_6.setGeometry(QRect(1050, 470, 271, 61))
        ...
        self.hand_button.setGeometry(QRect(1120, 620, 141, 41))
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"Rover state", None))
        self.label_6.setText(QCoreApplication.translate("Form", u"Speed Motor 1:", None))
        self.speed_label_1.setText("")
        self.label_7.setText(QCoreApplication.translate("Form", u"Speed Motor 2:", None))
        self.speed_label_2.setText("")
        self.label_11.setText(QCoreApplication.translate("Form", u"Encoder Counts 1:", None))
        self.label_12.setText(QCoreApplication.translate("Form", u"Encoder Counts 2:", None))
        self.count_label_1.setText("")
        self.count_label_2.setText("")
        self.label_14.setText(QCoreApplication.translate("Form", u"Speed:", None))
        self.label_15.setText(QCoreApplication.translate("Form", u"Direction:", None))
        self.speed_label.setText("")
        self.dir_label.setText("")
        self.camera_label.setText("")
        self.label_9.setText(QCoreApplication.translate("Form", u"Bor3y out of memory", None))
        self.manuel_button.setText(QCoreApplication.translate("Form", u"Manuel", None))
        self.auto_button.setText(QCoreApplication.translate("Form", u"Auto", None))
